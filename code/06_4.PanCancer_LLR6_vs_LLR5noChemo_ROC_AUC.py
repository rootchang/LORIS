...
if __name__ == "__main__":
    ...
    if chemo_type == 1:
        ...
        dataALL[-2] = dataALL[-1]
        dataALL = [c.loc[c['Chemo_before_IO'] == 0, :] for c in dataALL]
    ...
    df.to_csv('../03.Results/source_data_efig10a.csv', index=False)


    ############################## Plot ROC curves ##############################
    textSize = 8
    output_fig1 = '../03.Results/PanCancer_LLR6_LLR5noChemo_ROC_compare.pdf'
    ax1 = [0] * 6
