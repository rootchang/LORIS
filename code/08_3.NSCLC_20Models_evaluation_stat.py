...
MLM_list = ['LLR6', 'LLR5noTMB', 'TMB', 'LogisticRegression', 'DecisionTree','RF6', 'RF16_NBT',
...
MLM_list1=['TMB', 'DecisionTree', 'RF6', 'RF16_NBT', 'RandomForest', 'RF16_NBT'] # data scaling: None
MLM_list2=['LLR6', 'LLR5noTMB', 'LogisticRegression','GBoost', 'AdaBoost', 'HGBoost', 'XGBoost',
           'CatBoost', 'LightGBM','SupportVectorMachineRadial','kNearestNeighbourhood','NeuralNetwork1',
           'NeuralNetwork2','NeuralNetwork3','NeuralNetwork4','GaussianProcess', "TabNet"] # StandardScaler
MLM_name_map = {'TMB':'TMB',
                'LLR6': 'LLR6', 'LLR5noTMB': 'LR5 (noTMB)', 'LogisticRegression': 'LR16',
...
for MLM in MLM_list:
    ...
    if MLM not in ["TabNet"]:
        ...
        try:
            data = [float(c) if c != '' else 0 for c in data]
        except:
            print(data)
            raise Exception('ctg')
