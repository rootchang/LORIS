...
Description: To study LORIS predictive power in merged Chowell et al. & MSK1 cohorts (Fig. 3, 4c,d; Extended Data Figs. 3, 4, 7, 8c,d; Supplementary Figs. 3)
(1) K-M survival curves for LORIS-high/TMB-high vs. LORIS-high/TMB-low vs. ... groups
...
selected_cols = c("SAMPLE_ID","Year of ICI treatment start", "TMB", "Chemo_before_IO", "CancerType", "Age", "NLR", "Albumin", "Drug", "Sex", "PFS_Event", "PFS_Months", "OS_Event", "OS_Months")
...
renamed_cols = c("SAMPLE_ID","Year_IO", "TMB", "Chemo_before_IO", "CancerType", "Age", "NLR", "Albumin", "Drug", "Sex", "PFS_Event", "PFS_Months", "OS_Event", "OS_Months")
...
write.csv(info_df, paste0(result_dir,"source_data_efig08.csv"))
...
write.csv(HR_each_cancer, paste0(result_dir,"source_data_fig03cd.csv"))
...
write.csv(PFSrate_score, paste0(result_dir,"source_data_efig03e.csv"))
...
write.csv(PFSrate_score, paste0(result_dir,"source_data_fig03e.csv"))
...
write.csv(quantile_plot, paste0(result_dir,"source_data_fig05cd.csv"))
