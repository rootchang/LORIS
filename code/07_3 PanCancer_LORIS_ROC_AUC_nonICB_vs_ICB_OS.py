...
#Description: Comparison of ROC / AUC of pan-cancer LLR6 on MSK-ICB cohort vs MSK-nonICB cohort.
#             (Fig. 5a)
#Run command: python 07_3.PanCancer_LORIS_ROC_AUC_nonICB_vs_ICB_OS.py
###############################################################################################
