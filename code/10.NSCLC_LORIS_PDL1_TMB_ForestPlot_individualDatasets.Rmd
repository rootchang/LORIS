...
(Fig. 6d,e; Extended Data Fig. 5b,c; Supplementary Fig. 7b,c)
###############################################################################################
...
train1_info_df = read_excel(paste0(input_dir,'features_phenotype_allDatasets.xlsx'), "Chowell2015-2017")
train1_info_df = train1_info_df[train1_info_df$CancerType=='NSCLC',selected_cols]
train2_info_df = read_excel(paste0(input_dir,'features_phenotype_allDatasets.xlsx'), "Chowell2018")
...
test2_info_df = read_excel(paste0(input_dir,'features_phenotype_allDatasets.xlsx'), "Lee_NSCLC")
test2_info_df = test2_info_df[selected_cols]
test3_info_df = read_excel(paste0(input_dir,'features_phenotype_allDatasets.xlsx'), "Vanguri_NSCLC_all")
test3_info_df = test3_info_df[selected_cols]
test4_info_df = read_excel(paste0(input_dir,'features_phenotype_allDatasets.xlsx'), "Ravi_NSCLC")
...
colnames(info_df) = c("SAMPLE_ID","TMB","PDL1","Chemo_before_IO","Age","Drug","Sex","PFS_Event","PFS_Months","OS_Event","OS_Months", "LLRscore", "DataSet")
...
write.csv(HR_each_cancer, paste0(result_dir,"source_data_efig06bcde.csv"))
